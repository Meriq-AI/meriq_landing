...
export async function generateMetadata({
  ...
  return {
    title: dict.plan.metaTitle,
    description: dict.plan.metaDescription,
    alternates: alternates("/export-plan", locale),
  }
}

export default async function ExportPlanPage({
  params,
}: {
  params: Promise<{ lang: string }>
}) {
    ...
    <>
      ...
      <main className="relative overflow-hidden">
        ...
        <div className="mx-auto w-full max-w-6xl px-6 pt-32 sm:pt-36">
          {/* PlanForm renders the page heading itself so the success screen
              can replace it. */}
          <PlanForm plan={dict.plan} lang={lang} />
        </div>
      </main>
